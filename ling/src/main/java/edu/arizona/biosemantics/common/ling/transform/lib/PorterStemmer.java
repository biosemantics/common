...
import edu.arizona.biosemantics.common.ling.transform.IStemmer;
...
public class PorterStemmer implements IStemmer {
	...
	@Override
	public List<String> getStems(String word, edu.arizona.biosemantics.common.ling.pos.POS pos) {
