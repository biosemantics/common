 ...
 * @author rodenhausen
 */
public class GlossaryBasedCharacterKnowledgeBase implements ICharacterKnowledgeBase {
	 ...
	 * @param negWords
	 */
	public GlossaryBasedCharacterKnowledgeBase(IGlossary glossary, 
			String negWords, String advModifiers, String stopWords, String units, IInflector inflector) {
